...
public class QuizpluginBase {
	...
	public void enterGroupCodeAndOpenQuiz() throws InterruptedException {
        ...
        System.out.println(driver.getPageSource());
		WebElement pluginButton =driver.findElements(By.className("eck-btn-cg")).get(0);
		...
		Boolean ifFailed2 = false;
		try {
			driver.findElements(By.className("plugin-list")).get(0).click();
		} catch (NoSuchElementException e) {
			ifFailed = true;
			try {
				Thread.sleep(10000);
